...
- The 'derivativeResult' field in your output MUST contain ONLY the resulting mathematical expression or value, formatted as a pure LaTeX string. Use standard LaTeX functions like \`\\sin\`, \`\\cos\`, \`\\ln\`, etc. Do not include any delimiters like \\(...\\) or \\$..\\$ in this field. Do not include any explanations, apologies, or conversational text in this field.
...
Ensure the 'derivativeResult' field contains a pure LaTeX string without delimiters.
Ensure ALL mathematical expressions, variables, and notations within the 'steps' are formatted with block MathJax/KaTeX delimiters \\[...\\]`,
  config: {
    temperature: 0.1, 
    safetySettings: [
